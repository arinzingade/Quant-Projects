...
from coinswitch import place_order, get_ohlc_for_symbol
...
if __name__ == "__main__":
    ...
    while (True):
        ...
        if pos == "NEUTRAL":
            if third_last == False and second_last == True and last == True:
                pos = "LONG"
                logger.info("BUY")
                ...
                #place_order(api_key, secret_key, symbol, "SELL", "STOP_MARKET", qty, sym_price - brick_size)
